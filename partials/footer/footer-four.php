                    ...
                    <div class="cta__four-area t-center" style="background-image: url('assets/img/page/subscribe.jpg');">
                        <div class="cta__four-area-content">
                            ...
                            <div class="item_bounce">
                                <a class="build_button mt-40" href="contact.php">Free Consultation<i class="flaticon-right-up"></i></a> 
                            </div>
                        </div>
                    </div>
                </div>
						...
						<div class="row">
							<div class="col-lg-4 col-sm-6">
								<div class="footer__four-widget mr-40">
									<a class="logo" href="index.php"><img src="assets/img/logo-3.png" alt="logo"></a>
								...
								<div class="footer__four-widget ml-40 lg-ml-0">
									...
									<div class="footer-widget-menu">
										<ul>
											...
											<li><a href="blog-grid-three.php">Blog</a></li>
			...
			<div class="row al-center">
				<div class="col-md-7">
					<div class="copyright__area-content md-t-center md-mb-10">
						<p>Copyright 2025 – All Rights Reserved By <a href="https://themeforest.net/user/wpcodify/portfolio" target="_blank">wpCodify</a></p>
					</div>
				</div>
				<div class="col-md-5">
