<?php $title = 'FAQs'; $home='Home'; $subtitle='FAQs'; ?>
            ...
            <div class="row jc-center">
                <div class="col-xl-10">
                    <div class="wow fadeInUp" data-wow-delay=".4s" id="accordionExample">
                        <div class="faq-item">
                            <h5 class="icon" data-bs-toggle="collapse" data-bs-target="#collapseOne">Can I return construction materials if I order too much?</h5>
                        ...
                        <div class="faq-item">
                            <h5 class="icon collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">What should I do if I receive damaged construction materials?</h5>
                        ...
                        <div class="faq-item">
                            <h5 class="icon collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">Are there any eco-friendly options for construction materials?</h5>
                        ...
                        <div class="faq-item">
                            <h5 class="icon collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour">How should I prepare for the delivery of construction materials?</h5>
                        ...
                        <div class="faq-item">
                            <h5 class="icon collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFive">What factors can affect the cost of construction materials?</h5>
                            <div id="collapseFive" class="faq-item-body collapse" data-bs-parent="#accordionExample">
                                <p>The cost of construction materials can be influenced by several factors, including:</p>
                                <ul>
                                    <li><strong>Supply and Demand:</strong> Fluctuations in demand or shortages in supply can lead to price increases.</li>
                                    <li><strong>Material Type:</strong> Different materials have varying costs based on quality and availability.</li>
